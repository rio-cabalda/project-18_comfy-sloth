    ...
    <Wrapper>
      <div className="title">
        ...
        <div>
          ...
          <h5 className="price-small"> {/* this will show only when in small screen*/}
            {formatPrice(price)}
          </h5>
        </div>
      </div>
      <h5 className="price"> {formatPrice(price)}</h5> {/* this will show only when in larger screen in column price*/}
      <QuantityButtons quantity={quantity} increase={increase} decrease={decrease}></QuantityButtons>
